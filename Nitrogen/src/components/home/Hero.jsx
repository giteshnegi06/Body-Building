        ...
        <div className="max-w-3xl">
          ...
          >
            ...
            <p className="text-lg md:text-xl text-white/70 max-w-xl mb-10 leading-relaxed font-light">
              Scientifically engineered supplements for serious athletes. Zero
              fillers, maximum results. Built for those who demand more from
              their bodies.
            </p>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 border-t border-white/10 pt-10">
            {[
              ...
              <div key={i} className="text-center md:text-left">
                <p className="text-neon-lime font-display text-4xl font-bold">
                  {stat.value}
                </p>
                <p className="text-white/40 uppercase text-xs tracking-widest mt-1">
                  {stat.label}
                </p>
              </div>
            ))}
